# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-02-23 06:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('truth_text', models.CharField(max_length=5000)),
            ],
        ),
        migrations.AddField(
            model_name='article',
        ...
        migrations.AddField(
            model_name='article',
            name='title',
            field=models.ManyToManyField(to='news.Title'),
        ),
        migrations.AddField(
            model_name='article',
            name='truth',
            field=models.ManyToManyField(to='news.Truth'),
        ),
    ]
